...
<template>
    <div id="PostOverlay" class="fixed z-50 top-0 left-0 w-full h-full bg-white bg-opacity-70">
        <div class="grid h-screen place-items-center p-4">
            <div class="bg-white w-full max-w-[600px] mx-auto shadow-xl rounded-xl">
                <div class="flex items-center relative my-3.5 mx-1">
                    ...
                    <div @click="isPostOverlay=false" class="absolute right-3 rounded-full p-1.5 bg-gray-200 hover:bg-gray-300 cursor-pointer">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="flex items-center justify-between w-[100px] bg-gray-200 p-0.5 px-2 rounded-lg">
                                    ...
                                    <ChevronDown class="pr-10 pl-1" :sizze="18" />
                                </div>
                            </div> 
                        </div>

                        <div class="max-h-[350px] overflow-auto">
                            <textarea v-model ="form.text" class="w-full border-0 mt-4  focus:ring-0 text-[22px]" placeholder="Whats on your mind?" cols="30" rows="3"></textarea>
                            <div v-if="form.image" class="p-2 border border-gray-300 rounded-lg relative">
                                <Close @click="clearImage()" class="absolute bg-white p-0.5 m-2 right-2 rounded-full border cursor-pointer" :size="24" fillColor="#5E6771" />
                            ...
                            <div class="border-2 rounded-xl mt-4 shadow-sm flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <input id="image" class="hidden" type="file" @input="getUploadedImage($event)" />
