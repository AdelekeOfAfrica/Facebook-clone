            ...
            <div class="w-full bg-white">
                <div class="max-w-[1100px] pt-[56px] mx-auto pb-1">
                        ...
                        <div class="flex  md:flex-row flex-col gap-4 md:-mt-6 -mt-16 items-center">
                            ...
                            <div class="md:mt-4 text-center md:text-left -mt-3">
                                ...
                                <div class="flex md:justify-start justify-center md:ml-1">
                                    <img class="rounded-full -ml-1 z-[10] w-[40px] h-[40px] border-white  border-2" src="https://picsum.photos/id/141/300/300" />
                                      <img class="rounded-full -ml-3 z-[9] w-[40px] h-[40px] border-white  border-2" src="https://picsum.photos/id/142/300/300" />
                                        <img class="rounded-full -ml-3 z-[8] w-[40px] h-[40px] border-white  border-2" src="https://picsum.photos/id/143/300/300"/>
                                          <img class="rounded-full -ml-3 z-[7] w-[40px] h-[40px] border-white  border-2" src="https://picsum.photos/id/144/300/300"/>
                                            <img class="rounded-full -ml-3 z-[6] w-[40px] h-[40px] border-white  border-2" src="https://picsum.photos/id/145/300/300"/>
                                     <img class="rounded-full -ml-3 z-[5] w-[40px] h-[40px] border-white  border-2" src="https://picsum.photos/id/146/300/300"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex border-t h-[50px] py-[4px]">
                        <button class="w-[85px]">
                            <div class="flex items-center text-[15px] justify-center h-[45px] text-blue-500 hover:bg-[#F2F2F2] w-full font-bold rounded-lg cursor-pointer">
                                Post
                            </div>
            ...
            <div class="flex-cols md:flex w-full max-w-[1100px] justify-between h-[calc(100%-56px)] md:px-0 px-2 mx-auto">
                <div id="LeftSection" class="w-full md:w-5/12 mt-4 mr-4">
                    <div class="bg-white p-3 rounded-lg shadow-lg">
                        ...
                        <div class="pb-5">
                            <button class="w-full bg-gray-200 hover:bg-gray-300 rounded-lg p-2 font-semibold">Add Bio</button>
                        </div>

                        <div class="pb-5">
                            <button class="w-full bg-gray-200 hover:bg-gray-300 rounded-lg p-2 font-semibold">Edit Details</button>
                        </div>

                        <div class="pb-5">
                            <button class="w-full bg-gray-200 hover:bg-gray-300 rounded-lg p-2 font-semibold">Add Hobbies</button>
                        </div>

                        <div class="pb-5">
                            <button class="w-full bg-gray-200 hover:bg-gray-300 rounded-lg p-2 font-semibold">Add Feature</button>
                        </div>
                    </div>
